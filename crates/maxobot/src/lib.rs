...
//! capabilities such as dispatching, webhook adapters, and Botron integration.
...
/// Feature-gated integration namespace for the Botron adapter bridge.
#[cfg(feature = "botron-adapter")]
pub mod botron_adapter {
    pub use maxobot_botron_adapter::*;
}
